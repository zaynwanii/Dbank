...
function makeNonceTransform(nonceFn = _types__WEBPACK_IMPORTED_MODULE_2__.makeNonce) {
    return async (request) => {
        ...
        headers.set('X-IC-Request-ID', (0,_utils_buffer__WEBPACK_IMPORTED_MODULE_3__.toHex)(new Uint8Array(nonce)));
...
window.addEventListener("load",async()=>{
  ...
  var currentAmt=await _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__.dbank.checkBalance();
...
document.querySelector("form").addEventListener("submit",async (e)=>{
  ...
  if(document.getElementById("input-amount").value.length!=0){
    await _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__.dbank.topUp(inputAmt);
  }

  if(document.getElementById("withdrawal-amount").value.length!=0){
    console.log(outputAmt);
    await _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__.dbank.withdraw(outputAmt);
  }
